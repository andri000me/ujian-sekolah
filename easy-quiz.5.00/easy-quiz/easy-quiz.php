...
if (class_exists("EzQuiz")) {
  ...
  class EzQuiz extends EzBasePlugin {
    ...
    function __construct() { //constructor
      parent::__construct("easy-quiz", "Easy Quiz", __FILE__);
      ...
      $this->prefix = "ezQuiz";
      $this->themeName = get_option('stylesheet');
      $this->optionName = $this->prefix . $this->themeName;
...
<div class="submit">
<input class='button-primary' type="submit" name="update_ezQuiz" value="Save Changes" title="Save the changes as specified above" onmouseover="Tip('Save the changes as specified above',WIDTH, 240, TITLE, 'Save Changes')" onmouseout="UnTip()"/>
</div>
</form>
<hr />
